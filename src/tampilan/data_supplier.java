...
public class data_supplier extends javax.swing.JDialog {
    ...
    public void dataTable(){
        ...
        try{
            ...
            while(hasil.next()){
                ...
                String [] data = {"",id_supplier,kode,nama};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        if(txtKode.getText().equals("")){
            ...
            String sql = "INSERT INTO tb_supplier (kode_supplier, nama_supplier) VALUES (?, ?)";
            try{
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "UPDATE tb_supplier set kode_supplier=?, nama_supplier=? WHERE id_supplier ='"+txtId.getText()+"'";
        try{
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtKode.getText());
            stat.setString(2, txtNama.getText());
